 function i(c, s, u) {
	...
	for (var f = "function" == typeof require && require, t = 0; t < u.length; t++) a(u[t]);
	return a
}({
	1: [function(t, e, n) {
		e.exports = {
	...
	7: [function(t, e, n) {
		...
		var r = c(t("../core-js/symbol/iterator")),
			...
			i = "function" == typeof o["default"] && "symbol" == typeof r["default"] ? function(t) {
				...
				return t && "function" == typeof o["default"] && t.constructor === o["default"] && t !== o[
		...
		n["default"] = "function" == typeof o["default"] && "symbol" === i(r["default"]) ? function(t) {
			...
			return t && "function" == typeof o["default"] && t.constructor === o["default"] && t !== o[
				"default"].prototype ? "symbol" : void 0 === t ? "undefined" : i(t)
		}
	}, {
		"../core-js/symbol": 4,
	...
	9: [function(t, e, n) {
		t("../../modules/es6.string.iterator"), t("../../modules/es6.array.from"), e.exports = t(
			"../../modules/_core").Array.from
	}, {
		"../../modules/_core": 20,
	...
	12: [function(t, e, n) {
		t("../../modules/es6.symbol"), t("../../modules/es6.object.to-string"), t(
				"../../modules/es7.symbol.async-iterator"), t("../../modules/es7.symbol.observable"), e
			.exports = t("../../modules/_core").Symbol
	}, {
		"../../modules/_core": 20,
	...
	18: [function(t, e, n) {
		...
		e.exports = function(t) {
			var e, n, r;
			return t === undefined ? "Undefined" : null === t ? "Null" : "string" == typeof(n =
					function(t, e) {
						try {
							return t[e]
						} catch (n) {}
					}(e = Object(t), i)) ? n : c ? o(e) : "Object" == (r = o(e)) && "function" ==
				typeof e.callee ? "Arguments" : r
		}
	}, {
		"./_cof": 19,
		"./_wks": 74
		...
		var m = t("./_global"),
			...
			j = function(t, e, n) {
				var r, o, i, c = t & j.F,
					...
					d = p[v],
					_ = s ? m : u ? m[e] : (m[e] || {})[v];
				for (r in s && (n = e), n)(o = !c && _ && _[r] !== undefined) && g(p, r) || (i = o ? _[r] :
					n[r], p[r] = s && "function" != typeof _[r] ? n[r] : f && o ? b(i, m) : l && _[r] ==
					i ? function(r) {
						...
						return t[v] = r[v], t
					}(i) : a && "function" == typeof i ? b(Function.call, i) : i, a && ((p.virtual || (p
						.virtual = {}))[r] = i, t & j.R && d && !d[r] && y(d, r, i)))
			};
	...
	30: [function(t, e, n) {
		var r = e.exports = "undefined" != typeof window && window.Math == Math ? window : "undefined" !=
	...
	41: [function(t, e, n) {
		...
		e.exports = function(t, e, n, r, o, i, c) {
			...
			var s, u, a, f = function(t) {
				...
				h = m || f(o),
				b = o ? p ? f("entries") : h : undefined,
				y = "Array" == e && _.entries || m;
			if (y && (a = A(y.call(new t))) !== Object.prototype && a.next && (k(a, l, !0), g ||
					"function" == typeof a[E] || w(a, E, P)), p && m && m.name !== C && (d = !0, h =
					function() {
						return m.call(this)
					}), g && !c || !O && !d && _[E] || w(_, E, h), x[e] = h, x[l] = P, o)
				if (s = {
						values: p ? h : f(C),
						keys: i ? h : f("keys"),
						entries: b
		...
		var o = r("./_an-object"),
			...
			f = function() {
				var t, e = r("./_dom-create")("iframe"),
					n = c.length;
				for (e.style.display = "none", r("./_html").appendChild(e), e.src = "javascript:", (t = e
						.contentWindow.document).open(), t.write("<script>document.F=Object<\/script>"), t
					.close(), f = t.F; n--;) delete f[a][c[n]];
				return f()
			};
		t.exports = Object.create || function(t, e) {
			var n;
			return null !== t ? (u[a] = o(t), n = new u, u[a] = null, n[s] = t) : n = f(), e ===
				undefined ? n : i(n, e)
		}
	}, {
		"./_an-object": 16,
	...
	51: [function(t, e, n) {
		var r = t("./_to-iobject"),
			o = t("./_object-gopn").f,
			i = {}.toString,
			c = "object" == typeof window && window && Object.getOwnPropertyNames ? Object
	...
	54: [function(t, e, n) {
		...
		e.exports = Object.getPrototypeOf || function(t) {
			return t = o(t), r(t, i) ? t[i] : "function" == typeof t.constructor && t instanceof t
	...
	58: [function(t, e, n) {
		...
		e.exports = function(s) {
			return function(t) {
				for (var e, n = a(t), r = u(n), o = r.length, i = 0, c = []; i < o;) f.call(n, e =
					r[i++]) && c.push(s ? [e, n[e]] : n[e]);
				return c
			}
		}
	}, {
		...
		e.exports = function(s) {
			return function(t, e) {
				var n, r, o = String(a(t)),
					i = u(e),
					c = o.length;
				return i < 0 || c <= i ? s ? "" : undefined : (n = o.charCodeAt(i)) < 55296 ||
					56319 < n || i + 1 === c || (r = o.charCodeAt(i + 1)) < 56320 || 57343 < r ? s ?
					o.charAt(i) : n : s ? o.slice(i, i + 2) : r - 56320 + (n - 55296 << 10) + 65536
			}
		}
	}, {
		"./_defined": 23,
		...
		r(r.S + r.F * !t("./_iter-detect")(function(t) {
			...
			from: function(t) {
				var e, n, r, o, i = d(t),
					...
					f = 0,
					l = y(i);
				if (a && (u = p(u, 2 < s ? arguments[2] : undefined, 2)), l == undefined || c ==
					Array && m(l))
					for (n = new c(e = h(i.length)); f < e; f++) b(n, f, a ? u(i[f], f) : i[f]);
				else
					for (o = l.call(i), n = new c; !(r = o.next()).done; f++) b(n, f, a ? _(o,
						u, [r.value, f], !0) : r.value);
				return n.length = f, n
			}
		})
	}, {
	...
	77: [function(t, e, n) {
		...
		e.exports = t("./_iter-define")(Array, "Array", function(t, e) {
			...
			var t = this._t,
				e = this._k,
				n = this._i++;
			return !t || n >= t.length ? (this._t = undefined, o(1)) : o(0, "keys" == e ? n :
				"values" == e ? t[n] : [n, t[n]])
	...
	80: [function(t, e, n) {
		...
		var r = t("./_global"),
			...
			$ = function(t, e, n) {
				return t === V && $(q, e, n), y(t), e = j(e, !0), y(n), c(F, e) ? (n.enumerable ? (c(t,
					L) && t[L][e] && (t[L][e] = !1), n = x(n, {
						enumerable: w(0, !1)
					})) : (c(t, L) || C(t, L, w(1, {})), t[L][e] = !0), W(t, e, n)) : C(t, e, n)
			},
			K = function(t, e) {
				y(t);
				for (var n, r = h(e = v(e)), o = 0, i = r.length; o < i;) $(t, n = r[o++], e[n]);
				return t
			},
			Y = function(t) {
				var e = R.call(this, t = j(t, !0));
				return !(this === V && c(F, t) && !c(q, t)) && (!(e || !c(this, t) || !c(F, t) || c(this,
					L) && this[L][t]) || e)
			},
			Q = function(t, e) {
				if (t = v(t), e = j(e, !0), t !== V || !c(F, e) || c(q, e)) {
					var n = O(t, e);
					return !n || !c(F, e) || c(t, L) && t[L][e] || (n.enumerable = !0), n
				}
			},
			X = function(t) {
				for (var e, n = P(v(t)), r = [], o = 0; n.length > o;) c(F, e = n[o++]) || e == L || e ==
					u || r.push(e);
				return r
			},
			Z = function(t) {
				for (var e, n = t === V, r = P(n ? q : v(t)), o = [], i = 0; r.length > i;) !c(F, e = r[
					i++]) || n && !c(V, e) || o.push(F[e]);
				return o
			};
		U || (s((M = function() {
				if (this instanceof M) throw TypeError("Symbol is not a constructor!");
				var e = p(0 < arguments.length ? arguments[0] : undefined),
					n = function(t) {
						this === V && n.call(q, t), c(this, L) && c(this[L], e) && (this[L][
							e] = !1), W(this, e, w(1, t))
					};
				return o && G && W(V, e, {
					configurable: !0,
				...
				return this._k
			}), k.f = Q, A.f = $, t("./_object-gopn").f = S.f = X, t("./_object-pie").f = Y, t(
				"./_object-gops").f = Z, o && !t("./_library") && s(V, "propertyIsEnumerable", Y, !0), _
			.f = function(t) {
				return z(d(t))
			}), i(i.G + i.W + i.F * !U, {
			Symbol: M
		...
		for (var nt = E(d.store), rt = 0; nt.length > rt;) m(nt[rt++]);
		i(i.S + i.F * !U, "Symbol", {
			"for": function(t) {
			...
			stringify: function(t) {
				...
				if (n = e = r[1], (g(e) || t !== undefined) && !J(t)) return b(e) || (e =
					function(t, e) {
						if ("function" == typeof n && (e = n.call(this, t, e)), !J(e))
							return e
					}), r[1] = e, T.apply(N, r)
			}
		}), M[I][D] || t("./_hide")(M[I], D, M[I].valueOf), l(M, "Symbol"), l(Math, "Math", !0), l(r
			.JSON, "JSON", !0)
	}, {
		"./_an-object": 16,
		"./_descriptors": 24,
	...
	84: [function(t, e, n) {
		...
		for (var r = t("./_global"), o = t("./_hide"), i = t("./_iterators"), c = t("./_wks")(
				"toStringTag"), s =
	...
	87: [function(t, e, n) {
		...
		e.exports = function(l, t) {
			var p = 1 == l,
				...
				y = t || r;
			return function(t, e, n) {
				for (var r, o, i = j(t), c = v(i), s = g(e, n, 3), u = w(c.length), a = 0, f = p ?
						y(t, u) : d ? y(t, 0) : undefined; a < u; a++)
					if ((b || a in c) && (o = s(r = c[a], a, i), l))
						if (p) f[a] = o;
						else if (o) switch (l) {
					case 3:
						return !0;
	...
	88: [function(t, e, n) {
		...
		e.exports = function(t) {
			var e;
			return o(t) && ("function" != typeof(e = t.constructor) || e !== Array && !o(e.prototype) ||
					(e = undefined), r(e) && null === (e = e[i]) && (e = undefined)), e === undefined ?
				Array : e
		}
	}, {
		"./_is-array": 103,
		...
		var m = t("./_global"),
			...
			j = function(t, e, n) {
				var r, o, i, c, s = t & j.F,
					...
					f = t & j.P,
					l = t & j.B,
					p = u ? m : a ? m[e] || (m[e] = {}) : (m[e] || {})[v],
					d = u ? h : h[e] || (h[e] = {}),
					_ = d[v] || (d[v] = {});
				for (r in u && (n = e), n) i = ((o = !s && p && p[r] !== undefined) ? p : n)[r], c = l &&
					o ? g(i, m) : f && "function" == typeof i ? g(Function.call, i) : i, p && y(p, r, i, t &
						j.U), d[r] != i && b(d, r, c), f && _[r] != i && (_[r] = i)
			};
		m.core = h, j.F = 1, j.G = 2, j.S = 4, j.P = 8, j.B = 16, j.W = 32, j.U = 64, j.R = 128, e.exports =
			j
	}, {
		"./_core": 91,
		"./_ctx": 92,
	...
	108: [function(t, e, n) {
		...
		t("./_core").inspectSource = function(t) {
			...
			o && (s(n, "name") || c(n, "name", e)), t[e] !== n && (o && (s(n, u) || c(n, u, t[e] ?
					"" + t[e] : a.join(String(e)))), t === i ? t[e] = n : r ? t[e] ? t[e] = n :
				c(t, e, n) : (delete t[e], c(t, e, n)))
	...
	119: [function(t, e, n) {
		...
		var s = function(t) {
				var e = (0, c.generateParams)(),
					...
					r = new Image;
				window.sohuSpm && window.sohuSpm.isDebug && console.log("%c SpmEv %c Send: %c" + t,
						"background:#fccf2f;color:#3d2e16;", "color:#fccf2f;background:#3d2e16",
						"font-size: 12px"), r.src = "//" + c.trackHost + "/se.gif?" + n + "&spm-cnt-arr=" +
					(0, c.encode)(t)
			},
			u = new(function() {
				function n() {
				...
				return n.prototype.send = function(t) {
					...
					for (var e = "", n = {}, r = this._collections.concat(), o = 0; o < this
						._collections.length; o++) {
						var i = this._collections[o].spmCnt + "," + (this._collections[o].url ||
							"") + "," + (this._collections[o].scmCnt || "");
						if (!n[i]) {
							if (0 === o) e = i;
							else {
	...
	120: [function(t, e, n) {
		...
		var r = {
			...
			listen: function(t, e) {
				...
				this.client[n] || (this.client[n] = []), this.client[n][t] || (this.client[n][
				t] = []), this.client[n][t].push(e)
			},
			trigger: function() {
	...
	121: [function(t, e, n) {
		...
		n.resetHref = x, n.shouldResetHref = S, n.genSpmContent = k, n.encode = M, n._addEventListeners =
			function() {
				D("scroll", function() {
					L()
				}, h), D("touchmove", function() {
					L()
				}, h)
				...
				e.forEach(function(t, e) {
					if (!(f && t.getAttribute("data-spm") !== f || "init" === t.getAttribute(
							"data-spm-stop") && a)) {
						var n = (0, d["default"])(t.querySelectorAll("*")).filter(function(t) {
							...
							r = [];
						if (n.length) {
							var o = (r = (r = (0, d["default"])(t.querySelectorAll("*")).filter(
									function(t) {
										return "resource" === t.getAttribute(
											"data-spm-type")
									})).filter(function(t) {
								...
								i = r.length - o.length;
							! function(t, f) {
								var i = 2 < arguments.length && arguments[2] !== undefined ?
									arguments[2] : 0;
								t.forEach(function(c, t) {
									if (!c._spmHashID) {
										var s = c.getAttribute("data-spm-data") || i + t +
										1;
										c.setAttribute("data-spm-data", s);
										var u = M(v + "." + j + "." + f.getAttribute(
												"data-spm") + "." + c.getAttribute(
												"data-spm-data")),
											a = "",
											e = (0, d["default"])(c.querySelectorAll("*"))
											.filter(function(t) {
												return P(t)
											});
										e.forEach(function(t, e) {
											...
											var n = C(t, u + "." + w);
											if (n && c.setAttribute(
													"data-spm-content", n), t
												.getAttribute("data-spm-acode") &&
												O(t, f, !1), t.getAttribute(
													"data-spm-content-value") && t
												.setAttribute(
													"data-spm-content-value", x(t
														.getAttribute(
															"data-spm-content-value"
															), u + "." + w)), S(
												t) && (t.href = x(t.href, u + "." +
													w)), "content" === t
												.getAttribute("data-spm-type")) {
												var r = k(t),
													o = r.spmCnt,
													i = r._scmCnt;
												a = i, c.setAttribute(
										...
										if (!c.getAttribute("data-spm-content-value") && !c
											.getAttribute("data-spm-content") && 1 === n
											.length) {
											var r = k(n[0]),
												o = r.spmCnt;
											c.setAttribute("data-spm-content", o)
										}
										c._spmHashID = E(7), Object.defineProperty(c,
											"_spmHashID", {
												enumerable: !1,
												writable: !1
											}), (0, m.installEvent)(c), c.listen(
											"exposure",
											function() {
												_.evCollector.send({
													spmCnt: u,
							...
							var c = (0, d["default"])(t.querySelectorAll("*")).filter(function(t) {
								...
								u = c.length - s.length;
							! function(t, u) {
								var a = 2 < arguments.length && arguments[2] !== undefined ?
									arguments[2] : 0;
								t.forEach(function(t, e) {
									var n = t.getAttribute("data-spm-data") || a + e + 1;
									t.setAttribute("data-spm-data", n), t.getAttribute(
										"data-spm-acode") && O(t, u);
									var r = M(v + "." + j + "." + u.getAttribute(
										"data-spm") + "." + t.getAttribute(
											"data-spm-data"));
									t.getAttribute("data-spm-content-value") && t
										.setAttribute("data-spm-content-value", x(t
											.getAttribute("data-spm-content-value"), r +
											"." + w)), S(t) && (t.href = x(t.href, r + "." +
											w)), C(t, r + "." + w);
									var o = k(t),
										i = o._scmCnt,
										c = o.spmCnt;
									...
									Object.defineProperty(t, "_spmHashID", {
										enumerable: !1,
										writable: !1
									}), (0, m.installEvent)(t), t.listen("exposure",
										function() {
											_.evCollector.send({
												spmCnt: r,
												url: t.getAttribute(
				...
				window.sohuSpm && window.sohuSpm.isDebug && console.log("%c SpmPv %c Send: %c" + n,
					"background:#fccf2f;color:#3d2e16;", "color:#fccf2f;background:#3d2e16",
					"font-size: 12px");
				t.src = "//" + g + "/sv.gif?" + n + "&spm-cnt=" + v + "." + j + ".0.0." + w, _.evCollector
					.sendEmptyNow()
			}, n.sendAction = N, n.getQueryString = T, n.generateParams = I, n.syclicScan = function() {
				var t = 0 < arguments.length && arguments[0] !== undefined ? arguments[0] : 1e3;
				setInterval(function() {
					L()
				}, t)
			}, n.exposureVisibleEle = L, n.turnRed = function() {
		...
		var g = n.trackHost = c,
			...
			v = n.aCode = (0, d["default"])(h.getElementsByTagName("meta")).filter(function(t) {
				return "data-spm" === t.name
			}).length && (0, d["default"])(h.getElementsByTagName("meta")).filter(function(t) {
				return "data-spm" === t.name
			})[0].getAttribute("content"),
			j = n.bCode = h.getElementsByTagName("body")[0].getAttribute("data-spm"),
			w = n.eCode = window.sohuSpm && window.sohuSpm._eCode || (new Date).getTime() + E(7);

		function u(t) {
			var e = window.innerHeight || h.documentElement.clientHeight,
				n = window.innerWidth || h.documentElement.clientWidth,
		...
		function x(t, e) {
			...
			var u = t.split("#"),
				a = u[0],
				f = u.slice(1);
			return (f = f.join("#")) && (f = "#" + f), s.length && (~a.indexOf("?") ? a += "&" + s.join(
				"&") : a += "?" + s.join("&")), a + f
		}

		function S(t) {
			if (!(t = t || h.createElement("a")).tagName || "A" !== t.tagName || null === t.getAttribute(
					"href")) return !1;
			if ("true" === t.getAttribute("data-spm-force") || !0 === t.getAttribute("data-spm-force"))
				return !0;
			var e = t.href;
		...
		function A(t) {
			return (0, d["default"])(h.querySelectorAll(t))
		}
		...
		function O(e, t) {
			var n = !(2 < arguments.length && arguments[2] !== undefined) || arguments[2],
				r = M(v + "." + j + "." + t.getAttribute("data-spm") + "." + e.getAttribute(
					"data-spm-data"));
			(0, m.installEvent)(e), e.getAttribute("data-spm-data") && n && e.listen("exposure",
		function() {
				_.evCollector.send({
					spmCnt: r
				})
		...
		function C(t, e) {
			if ("promotion" === t.getAttribute("data-spm-type")) {
				var n = void 0;
				if (t.getAttribute("data-spm-promo")) n = "promotion-" + t.getAttribute("data-spm-promo"), t
					.setAttribute("data-spm-content", n);
				else if (t.href) {
				...
				return t.getAttribute("data-spm-content-value") && ((0, m.installEvent)(t), D("click",
					function(t) {
						N({
							acode: 3600,
							clkParam: {
			...
			if ("ad" === t.getAttribute("data-spm-type")) return t.setAttribute("data-spm-content", "ad"),
				"ad"
		}
		...
		function P(t) {
			var e = 1 < arguments.length && arguments[1] !== undefined && arguments[1],
				n = "A" === t.tagName;
			return e && (n = !1), n || "content" === t.getAttribute("data-spm-type") || "promotion" === t
				.getAttribute("data-spm-type") || "ad" === t.getAttribute("data-spm-type") || t
				.getAttribute("data-spm-acode")
		}

		function M(t) {
			return i.encodeURIComponent && "function" == typeof encodeURIComponent ? encodeURIComponent(t) :
				i.encodeURI && "function" == typeof i.encodeURI ? i.encodeURI(t) : t
		}
		...
		function N(t) {
			var e = t.acode,
				...
				s = new Image,
				u = I();
			u["spm-cnt"] = c || v + "." + j + ".0.0." + w, u.acode = n, u.clk_param = "null" === o ? "" : o,
				u.clk_param = "object" === (0, l["default"])(u.clk_param) ? (0, f["default"])(u.clk_param) :
				u.clk_param, u.cache = E(5);
			var a = (0, p["default"])(u).map(function(t) {
				return t.map(function(t) {
					return M(t)
				}).join("=")
			}).join("&");
			window.sohuSpm && window.sohuSpm.isDebug && console.log("%c SpmAv %c Send: %c" + a,
				"background:#fccf2f;color:#3d2e16;", "color:#fccf2f;background:#3d2e16",
				"font-size: 12px"), s.src = "//" + g + "/sa.gif?" + a
		}
		...
		function I() {
			return {
				page_refer_url: h.referrer.slice(0, 200),
				device_resolution: window.screen.width + "_" + window.screen.height + "_" + (window
					.devicePixelRatio || 1),
				"spm-pre": T(),
				"scm-cnt": T("scm"),
				traffic_trans: T("traffic_trans"),
				jump: T("jump"),
		...
		function L() {
			for (var t = b.concat(), e = window.innerHeight || h.documentElement.clientHeight, n = 0; n < b
				.length; n++) {
				var r = b[n],
					...
					c = o.height,
					s = o.width;
				c = c || r.offsetHeight, s = s || r.offsetWidth, 0 === c && 0 === s || (e < i || u(r) && (r
					.trigger && r.trigger("exposure"), t.splice(t.indexOf(r), 1)))
			}
			b = t
		}
		...
		function D(t, e) {
			...
			"string" != typeof t && console.error("Expected String but got" + (void 0 === t ? "undefined" :
				(0, l["default"])(t))), e && "function" != typeof e && console.error(
				"Expected function but got " + (void 0 === e ? "undefined" : (0, l["default"])(e)));
			var r = {
					click: "onclick",
					scroll: "onmousewheel"
				} [t] || t,
				o = "scroll" === t ? a(e) : e;
			window.attachEvent ? (window.sohuSpm && window.sohuSpm.isDebug && console.log(
				"Spm Event: attachEvent were found, add Event " + r), n.attachEvent(r, o)) : (window
				.sohuSpm && window.sohuSpm.isDebug && console.log("%c Spm %c Event:%c add Event " + r,
					"background:#fccf2f;color:#3d2e16;", "color:#fccf2f;background:#3d2e16",
					"font-size: 12px"), n.addEventListener(t, o))
		}
		...
		var s = new(function() {
			function t() {
				(0, i["default"])(this, t), this.domDidChange = function(t) {
					...
					}, this.syclicScan = c.syclicScan, this.reScan = c.exposureVisibleEle, this
					.sendAction = c.sendAction, this.isDebug = window.sohuSpm && window.sohuSpm
					.isDebug, this.turnRed = c.turnRed, this.consoleNodeStr = c.consoleNodeStr, this
					.getCodes = c.getCodes
			}
			return t.prototype.init = function() {
				try {
					(0, c.sendPv)(), (0, c.genSpmNode)({
						willIgnore: !0
					}), (0, c._addEventListeners)(), console.log("%c Sohu %c SPM %c v" + c
						.version + " has initialized!", "background:#fccf2f;color:#3d2e16;",
						"color:#fccf2f;background:#3d2e16", ""), console.log(
						"%c Sohu %c SPM %c Please be informed that when you see this information, SohuSPM SDK may have completed most of the initialization work. The work of sending PV and EV and the installation of events may have been completed.",
						"background:#fccf2f;color:#3d2e16;",
						"color:#fccf2f;background:#3d2e16", "")
				} catch (t) {
					console.error(t)
				}
			}, t
